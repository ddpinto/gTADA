...
if (pT == "DD"){
    load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.14_13_Mar_02_2017.lof_DD.damaging_DD.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.6.5.RData")
...
if (pT == "ASD")
    load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.14_13_Mar_02_2017.lof_AST_TADA.damaging_AST_TADA.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.10.RData")
...
if (pT == "ID")
        load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.14_13_Mar_02_2017.lof_ID.damaging_ID.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.8.RData")


if (pT == "EPI")
    load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.10_42_Mar_03_2017.lof_EPI.missense_EPI.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.4.RData")
#    load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.10_42_Mar_03_2017.lof_EPI.damaging_EPI.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.4.RData")
#    load("W_EPIgeneSetN2_BayesianPrior/DN.adjustBeta.1.1.nI2000.nThin.1.index.22_07_Feb_12_2017.lof_EPI.missense_EPI.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.6.901.RData")

if (pT == "CHD")
    load("W_AddGeneSet1/DN.adjustBeta.1.1.nI5000.nThin.1.index.10_42_Mar_03_2017.lof_CHD_allN1213.damaging_CHD_allN1213.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.4.RData")
#  load("W_EPIgeneSetN2_BayesianPrior/DN.adjustBeta.1.1.nI2000.nThin.1.index.22_07_Feb_12_2017.lof_CHD_allN1213.missense_CHD_allN1213.nGroupDN.2.nGroupCC.2.adjustRatio.1.0.05.sigmaPrior.6.901.RData")
...
#        tOut <- round(tOut, 3)
        write.table(tOut, paste0(OUTDIR_LLK, "/TestlogLLKxem.AddGenes.", annotationType, ".", annotationType2, ".",
                            "txt2"),

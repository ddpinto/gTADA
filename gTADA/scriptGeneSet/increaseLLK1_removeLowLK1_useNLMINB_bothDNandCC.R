...
if (pT == "SCZ"){
    load("W_SCZgeneSet3/GuipponiNoFIN.DNandCC.adjustHyperBeta.1..adjustRatioMut.1.3.nIteration1000.nThin.1.index.02_16_17_April.nGroupDN.3.nGroupCC.3.damaging.SameBeta.RData")
